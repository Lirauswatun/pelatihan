...
$data = mysqli_query($coon, "SELECT * FROM mahasiswa INNER JOIN program_studi ON mahasiswa.prodi_id = program_studi.prodi_id ORDER BY mhs_id DESC");
// var_dump($data);

$dataprodi = mysqli_query($coon, "SELECT * FROM program_studi");
?>
<!DOCTYPE html>
<html lang="en">
